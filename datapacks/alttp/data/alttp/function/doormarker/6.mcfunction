...
execute if entity @s[tag=do_open,tag=!double] run setblock ~ ~ ~ minecraft:spruce_fence_gate[facing=south,open=true]
...
execute if entity @s[tag=do_close,tag=!double] run setblock ~ ~ ~ minecraft:spruce_fence_gate[facing=south,open=false]
