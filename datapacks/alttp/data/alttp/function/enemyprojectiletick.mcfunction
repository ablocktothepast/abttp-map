...
execute as @e[type=armor_stand,tag=fs_fireball,tag=!medusaball] run data merge entity @s {ArmorItems:[{},{},{},{components:{"minecraft:custom_model_data":32},count:1,id:"minecraft:carrot_on_a_stick"}]}
