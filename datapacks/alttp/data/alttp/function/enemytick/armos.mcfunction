...
execute if score @s enemydummy matches 0.. run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 55}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
...
execute if score @s enemydummy matches ..-1 run particle block{block_state:"minecraft:cobblestone"} ~ ~0.5 ~ 0 0 0 0.1 10 force 
