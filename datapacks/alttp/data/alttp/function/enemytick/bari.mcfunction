...
#IDLE
execute if score @s animationtick matches 0..2 if score @s enemydummy matches ..200 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 93}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s animationtick matches 3..5 if score @s enemydummy matches ..200 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 92}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s animationtick matches 6..8 if score @s enemydummy matches ..200 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 94}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}

#CHARGING
execute if score @s enemydummy matches 201..240 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 95}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}

#CHARGED
execute if score @s animationtick matches 0..1 if score @s enemydummy matches 240.. run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 96}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s animationtick matches 2..3 if score @s enemydummy matches 240.. run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 97}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s animationtick matches 4..5 if score @s enemydummy matches 240.. run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 96}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s animationtick matches 6..7 if score @s enemydummy matches 240.. run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 97}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
