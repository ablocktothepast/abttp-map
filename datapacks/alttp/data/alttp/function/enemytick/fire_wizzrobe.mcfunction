...
execute if score @s enemydummy9 matches 0 run data merge entity @s {HandItems: [{Count: 1b, id: "minecraft:carrot_on_a_stick", tag: {CustomModelData: 141}}, {}]}
...
execute unless score @s enemydummy9 matches 0 if score @s enemydummy8 matches 1..5 run data merge entity @s {HandItems: [{Count: 1b, id: "minecraft:carrot_on_a_stick", tag: {CustomModelData: 142}}, {}]}
execute unless score @s enemydummy9 matches 0 if score @s enemydummy8 matches 6..10 run data merge entity @s {HandItems: [{Count: 1b, id: "minecraft:carrot_on_a_stick", tag: {CustomModelData: 143}}, {}]}

#SHOOTING ANIMATION
execute if score @s enemydummy matches ..1 if entity @p[distance=..10] unless entity @s[tag=icerodfrozen] run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 146}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy matches 2..5 if entity @p[distance=..10] unless entity @s[tag=icerodfrozen] run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 145}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy matches 6..9 if entity @p[distance=..10] unless entity @s[tag=icerodfrozen] run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 144}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
