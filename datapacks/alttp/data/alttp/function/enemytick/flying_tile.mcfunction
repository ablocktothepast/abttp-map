...
execute if entity @s[tag=link_init] unless entity @e[type=silverfish,tag=link_b] run particle block{block_state:"minecraft:green_glazed_terracotta"} ~ ~ ~ 0.05 0.1 0.05 0.05 5 force
...
execute if score @s enemydummy matches 52.. unless block ~ ~ ~ #gothrough run particle block{block_state:"minecraft:green_glazed_terracotta"} ~ ~ ~ 0.05 0.1 0.05 0.05 5 force
execute if score @s enemydummy matches 52.. unless block ~ ~ ~ #gothrough run kill @e[type=silverfish,tag=link_b]
execute if score @s enemydummy matches 52.. if entity @p[distance=..0.5] run particle block{block_state:"minecraft:green_glazed_terracotta"} ~ ~ ~ 0.05 0.1 0.05 0.05 5 force
execute if score @s enemydummy matches 52.. if entity @p[distance=..0.5] run kill @e[type=silverfish,tag=link_b]
execute if score @s enemydummy matches 52.. positioned ~ ~-1.3 ~ if entity @p[distance=..0.5] run particle block{block_state:"minecraft:green_glazed_terracotta"} ~ ~ ~ 0.05 0.1 0.05 0.05 5 force
