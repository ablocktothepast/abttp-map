...
execute unless block ^-0.5 ^ ^ #gothrough run particle block{block_state:"minecraft:coal_block"} ~ ~ ~ 0.5 0.4 0.5 0.1 25 force
...
execute unless block ^-0.5 ^-1 ^ #gothrough run particle block{block_state:"minecraft:coal_block"} ~ ~ ~ 0.5 0.4 0.5 0.1 25 force
