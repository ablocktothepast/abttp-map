...
particle block{block_state:"minecraft:gold_block"} ~ ~ ~ 0 0 0 0.01 1
...
execute if entity @s[nbt={HurtTime:10s}] run particle block{block_state:"minecraft:redstone_block"} ~ ~0.7 ~ 0 0 0 0.1 50 force