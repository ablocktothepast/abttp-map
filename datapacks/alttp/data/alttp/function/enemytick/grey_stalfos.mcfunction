...
execute if score @s enemydummy7 matches 0 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 195}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
...
execute if score @s enemydummy7 matches 1 if score @s enemydummy10 matches 1..4 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 196}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy7 matches 1 if score @s enemydummy10 matches 5..8 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 197}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
...
execute if score @s enemydummy matches ..-1 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 201}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}

execute if score @s enemydummy matches 105..110 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 198}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy matches 111..116 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 199}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy matches 117..119 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 200}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
...
#Pile
execute if score @s enemydummy2 matches 1.. run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 204}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
