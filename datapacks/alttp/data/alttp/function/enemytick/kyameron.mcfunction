...
#TEXTURE
execute if entity @s[tag=icerodfrozen] run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 78}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute unless entity @s[tag=icerodfrozen] run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 77}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
