...
execute at @s if score @s enemydummy matches 7 if block ^-1 ^ ^1.5 obsidian run scoreboard players set @s enemydummy8 0
execute at @s if score @s enemydummy matches 7 if block ^-1 ^ ^1.5 obsidian run scoreboard players set @s enemydummy 8
execute at @s if score @s enemydummy matches 7 run particle block{block_state:"minecraft:sand"}stone ~ ~ ~ 1 0.5 1 0.4 30 force
execute at @s if score @s enemydummy matches 7 run particle block{block_state:"minecraft:sand"}stone ^-1.5 ^ ^ 0.5 1 0.5 0.4 20 force
execute at @s if score @s enemydummy matches 7 run particle block{block_state:"minecraft:sand"}stone ^1.5 ^ ^ 0.5 1 0.5 0.4 20 force
...
execute if score @s enemydummy matches 6 run particle block{block_state:"minecraft:sand"} ~ ~0.25 ~ 0.5 0.3 0.5 0.5 50 force
execute if score @s enemydummy matches 6 at @e[type=armor_stand,tag=moldormbody1] run particle block{block_state:"minecraft:sand"} ~ ~0.25 ~ 0.3 0.3 0.3 0.5 50 force
execute if score @s enemydummy matches 6 at @e[type=armor_stand,tag=moldormbody2] run particle block{block_state:"minecraft:sand"} ~ ~0.25 ~ 0.3 0.3 0.3 0.5 40 force
execute if score @s enemydummy matches 6 at @e[type=armor_stand,tag=moldormbody3] run particle block{block_state:"minecraft:sand"} ~ ~0.25 ~ 0.2 0.2 0.2 0.5 30 force
execute if score @s enemydummy matches 6 at @e[type=armor_stand,tag=moldormbody4] run particle block{block_state:"minecraft:sand"} ~ ~0.25 ~ 0.1 0.1 0.1 0.5 20 force
execute if score @s enemydummy matches 6 if score @s enemydummy7 matches 80.. run scoreboard players set @s enemydummy 7

#Vulnerable state
execute if score @s enemydummy matches 8 run data merge entity @e[type=armor_stand,tag=moldormbody2,limit=1] {HandItems: [{components: {"minecraft:custom_model_data": 220}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy matches 8 run scoreboard players set @s enemydummy9 1
execute if score @s enemydummy matches 8 run data merge entity @e[type=armor_stand,tag=moldorm_head,limit=1] {HandItems: [{components: {"minecraft:custom_model_data": 219}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
...
execute if score @s enemydummy matches 8 at @e[type=armor_stand,tag=moldormbody2] run particle block{block_state:"minecraft:red_wool"} ~ ~ ~ 1 1.5 1 0 50 force
execute if score @s enemydummy matches 8 if score @s enemydummy8 matches 100.. run data merge entity @e[type=armor_stand,tag=moldormbody2,limit=1] {HandItems: [{components: {"minecraft:custom_model_data": 216}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy matches 8 if score @s enemydummy8 matches 100.. run data merge entity @e[type=armor_stand,tag=moldorm_head,limit=1] {HandItems: [{components: {"minecraft:custom_model_data": 214}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
...
#Purple tail
execute if score @s enemydummy9 matches 0 run data merge entity @e[type=armor_stand,tag=moldormbody4,limit=1] {HandItems: [{components: {"minecraft:custom_model_data": 218}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy9 matches 1 run data merge entity @e[type=armor_stand,tag=moldormbody4,limit=1] {HandItems: [{components: {"minecraft:custom_model_data": 221}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
...
execute if score @s enemydummy9 matches 1 at @e[type=armor_stand,tag=moldormbody4] run particle block{block_state:"minecraft:purple_concrete_powder"} ~ ~ ~ 0.5 1 0.5 10 20 force
execute if score @s enemydummy9 matches 1 at @e[type=armor_stand,tag=moldormbody4] run summon marker ~ ~ ~ {Tags:["purplegoo"]}
execute as @e[type=marker,tag=purplegoo] at @s run particle block{block_state:"minecraft:purple_concrete_powder"} ~ ~0.5 ~ 0.5 0.2 0.5 10 1 force
...
execute if entity @e[type=zombie,tag=moldormhitbox,nbt={HurtTime:10s}] run particle block{block_state:"minecraft:redstone_block"} ~ ~0.7 ~ 0 0 0 0.1 50 force
