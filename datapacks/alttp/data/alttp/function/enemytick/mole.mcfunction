...
#MODELS
execute if score @s enemydummy2 matches 1 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 90}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy2 matches 0 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 91}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
