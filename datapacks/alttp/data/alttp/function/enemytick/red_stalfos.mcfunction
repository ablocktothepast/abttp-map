...
execute if score @s enemydummy7 matches 0 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 175}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
...
execute if score @s enemydummy7 matches 1 if score @s enemydummy10 matches 1..4 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 176}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy7 matches 1 if score @s enemydummy10 matches 5..8 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 177}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}

#DAMAGE INDICATOR
execute store result score @s enemydummy15 run data get entity @e[type=zombie,tag=link_b,limit=1] HurtTime
execute at @s if score @s enemydummy2 matches 1.. unless block ^ ^ ^-0.5 #gothrough if score @s enemydummy15 matches 9 run particle block{block_state:"minecraft:redstone_block"} ~ ~0.7 ~ 0 0 0 0.1 50 force
execute if score @s enemydummy2 matches ..0 as @e[type=zombie,tag=link_b] at @s if block ~ ~-0.1 ~ #gothrough if entity @s[nbt={HurtTime:10s}] run particle block{block_state:"minecraft:redstone_block"} ~ ~0.7 ~ 0 0 0 0.1 50 force

#BONER
scoreboard players add @s enemydummy 1
execute if score @s enemydummy matches 55..56 unless entity @s[tag=icerodfrozen] run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 181}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy matches 57..59 unless entity @s[tag=icerodfrozen] run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 182}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy matches 60..64 unless entity @s[tag=icerodfrozen] run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 183}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
...
execute if score @s enemydummy2 matches 1..4 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 178}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy2 matches 5..14 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 179}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy2 matches 15..16 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 180}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
