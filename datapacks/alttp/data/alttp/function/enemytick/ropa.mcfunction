...
execute at @s if score @s enemydummy matches 17.. run particle block{block_state:"minecraft:sea_pickle"} ~ ~0.25 ~ 0.25 0.25 0.25 0.1 15 force
...
execute if score @s enemydummy3 matches 1..2 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 275}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy3 matches 3..4 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 276}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy3 matches 5..6 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 277}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy3 matches 7..8 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 278}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
