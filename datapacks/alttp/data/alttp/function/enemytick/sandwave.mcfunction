...
#Sand particles
execute if score @s enemydummy matches 10..15 run particle block{block_state:"minecraft:sand"}stone ~ ~1 ~ 3 0 3 0.1 50 force
execute if score @s enemydummy matches 15..20 run particle block{block_state:"minecraft:sand"}stone ~ ~2 ~ 3 0 3 0.1 60 force
execute if score @s enemydummy matches 20..25 run particle block{block_state:"minecraft:sand"}stone ~ ~3 ~ 4 0 4 0.1 70 force
execute if score @s enemydummy matches 25..30 run particle block{block_state:"minecraft:sand"}stone ~ ~4 ~ 4 0 4 0.1 80 force
execute if score @s enemydummy matches 30..35 run particle block{block_state:"minecraft:sand"}stone ~ ~5 ~ 6 0 6 0.1 90 force
execute if score @s enemydummy matches 35..40 run particle block{block_state:"minecraft:sand"}stone ~ ~6 ~ 8 0 8 0.1 100 force
execute if score @s enemydummy matches 40..45 run particle block{block_state:"minecraft:sand"}stone ~ ~5 ~ 10 0 10 0.1 110 force
execute if score @s enemydummy matches 45..50 run particle block{block_state:"minecraft:sand"}stone ~ ~4 ~ 12 0 12 0.1 120 force
execute if score @s enemydummy matches 50..55 run particle block{block_state:"minecraft:sand"}stone ~ ~3 ~ 14 0 14 0.1 130 force
execute if score @s enemydummy matches 55..60 run particle block{block_state:"minecraft:sand"}stone ~ ~2 ~ 16 0 16 0.1 140 force
execute if score @s enemydummy matches 60.. run particle block{block_state:"minecraft:sand"}stone ~ ~1 ~ 18 0 18 0.1 150 force
