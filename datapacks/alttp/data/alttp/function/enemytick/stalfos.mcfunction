...
execute if score @s enemydummy7 matches 0 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 172}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
...
execute if score @s enemydummy7 matches 1 if score @s enemydummy10 matches 1..4 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 173}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy7 matches 1 if score @s enemydummy10 matches 5..8 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 174}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}

#DAMAGE INDICATOR
execute if entity @e[type=zombie,tag=link_b,nbt={HurtTime:10s},nbt={OnGround:0b}] run particle block{block_state:"minecraft:redstone_block"} ~ ~0.7 ~ 0 0 0 0.1 50 force
