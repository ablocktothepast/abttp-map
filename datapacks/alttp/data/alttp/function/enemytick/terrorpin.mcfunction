...
execute if score @s enemydummy matches 1 if score @s enemydummy3 matches 0..3 if score @s bb_walking matches 1 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 82}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy matches 1 if score @s enemydummy3 matches 4..6 if score @s bb_walking matches 1 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 83}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy matches 2.. if score @s enemydummy3 matches 0..3 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 84}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy matches 2.. if score @s enemydummy3 matches 4..6 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 85}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy matches 1 if score @s bb_walking matches 0 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 81}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
