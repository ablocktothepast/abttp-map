...
execute if score @s enemydummy9 matches 0 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 129}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
...
execute unless score @s enemydummy9 matches 0 if score @s enemydummy8 matches 1..5 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 130}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute unless score @s enemydummy9 matches 0 if score @s enemydummy8 matches 6..10 run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 131}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}

#SHOOTING ANIMATION
execute if score @s enemydummy matches ..1 if entity @p[distance=..10] run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 134}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy matches 2..5 if entity @p[distance=..10] run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 133}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
execute if score @s enemydummy matches 6..9 if entity @p[distance=..10] run data merge entity @s {HandItems: [{components: {"minecraft:custom_model_data": 132}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}

#DAMAGE INDICATOR
execute if entity @e[type=armor_stand,tag=link_b,nbt={HurtTime:10s}] run particle block{block_state:"minecraft:redstone_block"} ~ ~0.7 ~ 0 0 0 0.1 50 force
