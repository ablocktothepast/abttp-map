...
data merge entity @e[type=armor_stand,tag=percival,limit=1] {HandItems: [{components: {"minecraft:custom_model_data": 306}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
...
data merge entity @e[type=armor_stand,tag=lysander,limit=1] {HandItems: [{components: {"minecraft:custom_model_data": 307}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
...
data merge entity @e[type=armor_stand,tag=fiona,limit=1] {HandItems: [{components: {"minecraft:custom_model_data": 311}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
