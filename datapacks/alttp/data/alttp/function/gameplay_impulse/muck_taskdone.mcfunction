...
data merge entity @e[tag=percival,limit=1] {HandItems: [{components: {"minecraft:custom_model_data": 306}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
tp @e[tag=lysander] -319 -1 714 46 0
data merge entity @e[tag=lysander,limit=1] {HandItems: [{components: {"minecraft:custom_model_data": 307}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
tp @e[tag=fiona] -247 -6 725 114 0
data merge entity @e[tag=fiona,limit=1] {HandItems: [{components: {"minecraft:custom_model_data": 311}, count: 1, id: "minecraft:carrot_on_a_stick"}, {}]}
