...
give @p minecraft:shears[minecraft:custom_model_data=1,minecraft:lore=['{"text":"Quest Item","color":"gold","italic":false}','{"text":"Use this to clean cobwebs and","color":"white","italic":false}','{"text":"get rid of spiders!","color":"white","italic":false}'],minecraft:enchantments={levels:{"minecraft:efficiency":10},show_in_tooltip:0b},minecraft:unbreakable={},minecraft:custom_name='{"text":"Cobweb Duster","color":"red","italic":false}',minecraft:can_break={predicates:[{blocks:"minecraft:cobweb"}]}] 1
