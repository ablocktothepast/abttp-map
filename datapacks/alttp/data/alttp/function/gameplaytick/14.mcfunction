...
execute positioned -281 14 642 if entity @p[distance=..4] at @p unless block ~ ~-0.01 ~ #gothrough unless score agathacat1 gameplay matches 1.. if score questprog dummy matches 1 run scoreboard players set agathacat1 gameplay 1
execute positioned -275 15 600 if entity @p[distance=..4] at @p unless block ~ ~-0.01 ~ #gothrough unless score agathacat2 gameplay matches 1.. if score questprog dummy matches 2 run scoreboard players set agathacat2 gameplay 1
execute positioned -331 14 647 if entity @p[distance=..4] at @p unless block ~ ~-0.01 ~ #gothrough unless score agathacat3 gameplay matches 1.. if score questprog dummy matches 3 run scoreboard players set agathacat3 gameplay 1
...
##Cat held
execute if score secondbatch gameplay matches 1 if score questprog dummy matches 5 unless entity @p[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",count:1,Slot:103b,components:{"minecraft:custom_name":'{"color":"yellow","italic":false,"text":"Agatha\'s cat"}',"minecraft:lore":['{"color":"gold","italic":false,"text":"Quest item"}','{"color":"white","italic":false,"text":"Bring the cat back safely to Agatha!"}'],"minecraft:custom_model_data":297}}]}] run clear @p carrot_on_a_stick[minecraft:custom_model_data=297]
...
##Cobweb duster
execute if score secondbatch gameplay matches 2 unless entity @p[nbt={Inventory:[{id:"minecraft:shears",Slot:0b,components:{"minecraft:custom_model_data":1}}]}] run clear @p shears[minecraft:custom_model_data=1]
