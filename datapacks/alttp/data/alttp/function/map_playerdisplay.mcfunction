...
execute unless entity @e[type=armor_stand,tag=map_player] run summon armor_stand 132 -62 3 {HandItems:[{components:{"minecraft:custom_model_data":66},count:1,id:"minecraft:carrot_on_a_stick"},{}],Invisible:1b,Marker:1b,NoGravity:1b,Pose:{RightArm:[0.0f,0.0f,0.0f]},Tags:["map_player"]}
