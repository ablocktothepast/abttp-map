#Pot breaking
execute as @e[type=item,nbt={Item:{id:"minecraft:stone",count:1}}] at @s run function alttp:pot_broken
...
execute as @e[type=item,nbt={Item:{id:"minecraft:tnt",count:1,components:{"minecraft:custom_name":'{"color":"blue","italic":false,"text":"Bomb"}',"minecraft:lore":['{"color":"white","italic":false,"text":"Throw to place a bomb."}']}}}] at @s run function alttp:bombitemtick
...
execute as @a at @s if score @s bombtick matches 0 run particle minecraft:explosion_emitter
...
execute as @a at @s if entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",count:1,components:{"minecraft:custom_name":'{"color":"dark_gray","italic":false,"text":"Fairy Bottle"}',"minecraft:lore":['{"color":"white","italic":false,"text":"Right-click to release it!"}'],"minecraft:custom_model_data":48}}]}] run function alttp:fairydeath_t
...
execute as @e[type=armor_stand,tag=chestitem,tag=boomerangy] if score @s enemydummy matches 10.. run data merge entity @s {ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",count:1,components:{"minecraft:custom_model_data":33}}]}
...
execute as @e[type=zombie,tag=enemy,tag=!protecc] at @s run data merge entity @s {ArmorItems:[{},{},{},{id:"minecraft:wither_rose",count:1}]}
