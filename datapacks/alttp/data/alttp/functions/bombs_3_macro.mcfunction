execute if score @p bombs matches 0 run item replace entity @p hotbar.4 with barrier{display:{Name:'{"text":"Out of bombs!","color":"dark_red","italic":false}',Lore:['{"text":"You\'re all out of bombs to throw!","color":"white","italic":false}']},CustomModelData:2} 1
