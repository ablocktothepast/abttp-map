...
execute if score dialoguetransitiontick2 dummy matches ..3 as @e[type=area_effect_cloud,tag=dialoguetransition] at @s facing entity @e[type=marker,tag=dialogueplayerpos] feet run tp @s ^ ^ ^0.05
execute as @e[type=area_effect_cloud,tag=dialoguetransition] at @s if entity @e[type=marker,tag=dialogueplayerpos,distance=..0.05] run function alttp:dialogue_transition2_post

execute if score dialoguetransitiontick2 dummy matches ..5 as @e[type=area_effect_cloud,tag=dialoguetransition] at @s facing entity @e[type=marker,tag=dialogueplayerpos] feet run tp @s ^ ^ ^0.05
execute as @e[type=area_effect_cloud,tag=dialoguetransition] at @s if entity @e[type=marker,tag=dialogueplayerpos,distance=..0.05] run function alttp:dialogue_transition2_post

execute if score dialoguetransitiontick2 dummy matches 3..10 as @e[type=area_effect_cloud,tag=dialoguetransition] at @s facing entity @e[type=marker,tag=dialogueplayerpos] feet run tp @s ^ ^ ^0.05
execute as @e[type=area_effect_cloud,tag=dialoguetransition] at @s if entity @e[type=marker,tag=dialogueplayerpos,distance=..0.05] run function alttp:dialogue_transition2_post

execute if score dialoguetransitiontick2 dummy matches 5..15 as @e[type=area_effect_cloud,tag=dialoguetransition] at @s facing entity @e[type=marker,tag=dialogueplayerpos] feet run tp @s ^ ^ ^0.05
execute as @e[type=area_effect_cloud,tag=dialoguetransition] at @s if entity @e[type=marker,tag=dialogueplayerpos,distance=..0.05] run function alttp:dialogue_transition2_post
...
execute if score dialoguetransitiontick2 dummy matches 0.. as @p at @s rotated as @e[type=area_effect_cloud,tag=dialoguetransition] run tp @s ~ ~ ~ ~ ~
execute if score dialoguetransitiontick2 dummy matches 0.. run ride @p mount @e[type=minecart,tag=dialogue_minecart,limit=1]
