...
execute if score hidedown gameplay matches 96..100 as @e[type=item_display,tag=aj.bernard.root] at @s run particle cloud ~ ~ ~ 0.5 1.5 0.5 0 200 force
execute if score hidedown gameplay matches 101..105 as @e[type=item_display,tag=aj.bernard.root] at @s run particle cloud ~ ~ ~ 0.5 1.3 0.5 0 150 force
execute if score hidedown gameplay matches 106..110 as @e[type=item_display,tag=aj.bernard.root] at @s run particle cloud ~ ~ ~ 0.5 1.0 0.5 0 100 force
execute if score hidedown gameplay matches 111..115 as @e[type=item_display,tag=aj.bernard.root] at @s run particle cloud ~ ~ ~ 0.5 0.7 0.5 0 50 force
execute if score hidedown gameplay matches 116..120 as @e[type=item_display,tag=aj.bernard.root] at @s run particle cloud ~ ~ ~ 0.5 0.4 0.5 0 20 force
execute if score hidedown gameplay matches 121..125 as @e[type=item_display,tag=aj.bernard.root] at @s run particle cloud ~ ~ ~ 0.5 0.2 0.5 0 10 force
execute if score hidedown gameplay matches 126..130 as @e[type=item_display,tag=aj.bernard.root] at @s run particle cloud ~ ~ ~ 0.5 0.1 0.5 0 5 force
...
execute if score hidedown gameplay matches 95 as @e[type=item_display,tag=aj.bernard.root] run function animated_java:bernard/animations/idle/stop
execute if score hidedown gameplay matches 95 as @e[type=item_display,tag=aj.bernard.root] run function animated_java:bernard/animations/hiding/play
