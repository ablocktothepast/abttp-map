...
execute if score secondbatch gameplay matches 1 if score # gameplay matches 14 if score 6 quests_2_progress matches ..4 run scoreboard players set id dialogue 254
execute if score secondbatch gameplay matches 1 if score # gameplay matches 14 if score 6 quests_2_progress matches ..4 as @e[type=item_display,tag=agatha] run function animated_java:agatha/animations/thank_you_thank_you/play
execute if score secondbatch gameplay matches 1 if score # gameplay matches 14 if score 6 quests_2_progress matches 5 run scoreboard players set id dialogue 256
