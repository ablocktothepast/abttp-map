execute if score # gameplay matches 5..12 run tp @e[tag=tristan] -246 -11 631 62 0
...
execute if score # gameplay matches 5..11 run scoreboard players set angle dialogue 20
