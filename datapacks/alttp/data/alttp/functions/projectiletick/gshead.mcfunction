...
execute if entity @p[distance=..0.5] run scoreboard players set @p set_damage 8
...
execute positioned ~ ~-1.45 ~ if entity @p[distance=..0.5] run scoreboard players set @p set_damage 8
